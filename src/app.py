...
activities = {
    ...
    "Basketball Team": {
        "description": "Join the competitive basketball team and participate in intramural games",
        "schedule": "Tuesdays and Thursdays, 4:30 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Play soccer and develop athletic skills with teammates",
